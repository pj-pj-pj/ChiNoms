...
Public Class Admin_Approved_Reservations
    ...
    Public Sub New()
        ...
        AddHandler Me.Activated, AddressOf Admin_Approved_Reservations_Activated
    End Sub

    Private Sub Admin_Approved_Reservations_Activated(sender As Object, e As EventArgs)
        LoadCustomers()
        UpdateDataGridView()
    End Sub
    ...
    Private Sub UpdateDataGridView()
        ...
        For Each customer In Customers
            For Each reservation In customer.listOfReservations
                If reservation.status = "Approved" Or reservation.status = "Approved & Paid" Then
    ...
    Private Sub btnApproved_Click(sender As Object, e As EventArgs) Handles btnCancelled.Click
        Me.Hide()
    ...
    Private Sub Admin_Approved_Reservations_Load(sender As Object, e As EventArgs) Handles MyBase.Load
