...
Partial Class Event_Hall
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Event_Hall))
        ...
        btnReviewReservation = New Button()
        lblprice = New Label()
        Label40 = New Label()
        btnBack = New LinkLabel()
        imgVenueBtn = New Button()
        ...
        Panel3.Controls.Add(btnReviewReservation)
        ...
        Label8.Location = New Point(752, 171)
        ...
        Label7.Location = New Point(752, 145)
        ...
        Label6.Location = New Point(752, 122)
        ...
        Label5.Location = New Point(752, 74)
        ...
        Label4.Location = New Point(752, 97)
        ...
        lblMaxCapacity.Location = New Point(396, 41)
        ...
        ' Label3
        ' 
        Label3.Font = New Font("Sitka Small", 12F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        Label3.ForeColor = Color.RosyBrown
        Label3.Location = New Point(396, 11)
        ...
        Label37.Location = New Point(38, 186)
        ...
        cbTypeOfEvent.Size = New Size(208, 31)
        ...
        cbEventVenue.Size = New Size(339, 50)
        ...
        Label24.Location = New Point(655, 26)
        ...
        Label25.Location = New Point(778, 166)
        ...
        Label26.Location = New Point(778, 144)
        Label26.Margin = New Padding(2, 0, 2, 0)
        Label26.Name = "Label26"
        Label26.Size = New Size(62, 23)
        Label26.TabIndex = 45
        Label26.Text = "14,000"
        ' 
        ' Label46
        ...
        Label27.Location = New Point(778, 117)
        ...
        Label28.Location = New Point(778, 94)
        Label28.Margin = New Padding(2, 0, 2, 0)
        Label28.Name = "Label28"
        Label28.Size = New Size(64, 23)
        Label28.TabIndex = 43
        Label28.Text = "20,000"
        ' 
        ' Label29
        ...
        Label29.Location = New Point(778, 68)
        Label29.Margin = New Padding(2, 0, 2, 0)
        Label29.Name = "Label29"
        Label29.Size = New Size(65, 23)
        Label29.TabIndex = 42
        Label29.Text = "40,000"
        ' 
        ' Label31
        ...
        Label31.Location = New Point(655, 166)
        ...
        Label32.Location = New Point(655, 144)
        ...
        Label33.Location = New Point(655, 117)
        ...
        Label34.Location = New Point(655, 94)
        ...
        Label35.Location = New Point(655, 68)
        ...
        ' cbKaraoke
        ' 
        cbKaraoke.Location = New Point(873, 165)
        ...
        ' cbDancer
        ' 
        cbDancer.Location = New Point(873, 143)
        ...
        ' cbSinger
        ' 
        cbSinger.Location = New Point(873, 116)
        ...
        ' cbCatering
        ' 
        cbCatering.Location = New Point(873, 68)
        ...
        ' cbClown
        ' 
        cbClown.Location = New Point(873, 91)
        ...
        ' noOfGuests
        ' 
        noOfGuests.BackColor = Color.FromArgb(CByte(246), CByte(204), CByte(217))
        noOfGuests.BorderStyle = BorderStyle.None
        noOfGuests.Font = New Font("Segoe UI", 14.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        noOfGuests.Location = New Point(201, 160)
        noOfGuests.Margin = New Padding(2)
        noOfGuests.Name = "noOfGuests"
        noOfGuests.Size = New Size(49, 26)
        noOfGuests.TabIndex = 25
        noOfGuests.Text = "10"
        ' 
        ' btnReviewReservation
        ' 
        btnReviewReservation.BackgroundImage = CType(resources.GetObject("btnReviewReservation.BackgroundImage"), Image)
        btnReviewReservation.BackgroundImageLayout = ImageLayout.Zoom
        btnReviewReservation.FlatAppearance.BorderSize = 0
        btnReviewReservation.FlatStyle = FlatStyle.Flat
        btnReviewReservation.Location = New Point(655, 219)
        btnReviewReservation.Margin = New Padding(2)
        btnReviewReservation.Name = "btnReviewReservation"
        btnReviewReservation.Size = New Size(267, 54)
        btnReviewReservation.TabIndex = 24
        btnReviewReservation.UseVisualStyleBackColor = True
        ' 
        ' lblprice
        ' 
    ...
    Friend WithEvents btnReviewReservation As Button
    ...
    Friend WithEvents imgVenueBtn As Button
End Class
