...
Partial Class Pending_Reservations
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Pending_Reservations))
        ...
        Panel1.Name = "Panel1"
        Panel1.Size = New Size(281, 554)
        Panel1.TabIndex = 12
        ' 
        ' btnPending
        ' 
        btnPending.BackColor = Color.FromArgb(CByte(239), CByte(192), CByte(208))
